...
def create_bracket_orders(strategy):
    ...
    strategy.log(f'[多单]：买入价格 {buy_price:.2f}，止盈价格 {take_profit_price:.2f}，止损价格 {stop_loss_price:.2f}')
    return strategy.buy_bracket(stopprice=stop_loss_price, limitprice=take_profit_price)
